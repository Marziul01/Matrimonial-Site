                    ...
                    @csrf
                        <div class="modal-body">
                                ...
                                <div class=" row p-0 m-0 column-gap-2 row-gap-2">
                                    ...
                                    <div class="col-6 mb-2">
                                        <label for="">Support Section Access?</label>
                                    ...
                                    <div class="col-6 mb-2">
                                        <label for="">Pages Settings Section Access?</label>
                         ...
                         <form action="{{ route('adminUManagepdate', $admin->id) }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="role_name" id="" class="form-control">
                                    ...
                                    <option value="Admin" {{ $admin->role_name == 'Admin' ? 'selected' : '' }} >Admin</option>
                                    <option value="Sub Admin" {{ $admin->role_name == 'Sub Admin' ? 'selected' : '' }}>Sub Admin</option>
                                </select>
                            </div>
                            <div class="form-group">
                            ...
                            <div class=" row p-0 m-0 column-gap-2 row-gap-2">
                                ...
                                <div class="col-6 mb-2">
                                    <label for="">Support Section Access?</label>
                                    <select name="courses" id="" class="form-control">
                                        <option value="1" {{ $admin->access->courses == 1 ? 'selected' : '' }} >Yes</option>
                                        <option value="2" {{ $admin->access->courses == 2 ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                                {{-- <div class="col-6 mb-2">
                                    <label for="">Blogs Section Access?</label>
                                    <select name="blogs" id="" class="form-control">
                                        <option value="1" {{ $admin->access->blogs == 1 ? 'selected' : '' }} >Yes</option>
                                        <option value="2" {{ $admin->access->blogs == 2 ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                                <div class="col-6 mb-2">
                                    <label for="">Payments Methods Section Access?</label>
                                    <select name="payment_methods" id="" class="form-control">
                                        <option value="1" {{ $admin->access->payment_methods == 1 ? 'selected' : '' }} >Yes</option>
                                        <option value="2" {{ $admin->access->payment_methods == 2 ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                                <div class="col-6 mb-2">
                                    <label for="">Coupon Section Access?</label>
                                    <select name="coupons" id="" class="form-control">
                                        <option value="1" {{ $admin->access->coupons == 1 ? 'selected' : '' }} >Yes</option>
                                        <option value="2" {{ $admin->access->coupons == 2 ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                                <div class="col-6 mb-2">
                                    <label for="">Affiliate Commissions Section Access?</label>
                                    <select name="affiliate_commission" id="" class="form-control">
                                        <option value="1" {{ $admin->access->affiliate_commission == 1 ? 'selected' : '' }} >Yes</option>
                                        <option value="2" {{ $admin->access->affiliate_commission == 2 ? 'selected' : '' }}>No</option>
                                    </select>
                                </div> --}}
                                <div class="col-6 mb-2">
                                    <label for="">Site Settings Section Access?</label>
                                    <select name="site_settings" id="" class="form-control">
                                        <option value="1" {{ $admin->access->site_settings == 1 ? 'selected' : '' }} >Yes</option>
                                        <option value="2" {{ $admin->access->site_settings == 2 ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                                <div class="col-6 mb-2">
                                    <label for="">Pages Settings Section Access?</label>
                                    <select name="home_settings" id="" class="form-control">
                                        <option value="1" {{ $admin->access->home_settings == 1 ? 'selected' : '' }} >Yes</option>
                                        <option value="2" {{ $admin->access->home_settings == 2 ? 'selected' : '' }}>No</option>
                                    </select>
                                </div>
                            </div>
